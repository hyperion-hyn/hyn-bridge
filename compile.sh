...
/Users/moo/project/github/go-ethereum/build/bin/abigen --bin=./build/bin/ERC20HecoManager.bin --abi=./build/abi/ERC20HecoManager.abi --type=ERC20HecoManager --pkg=main --out=./deploy/heco/auto_gen_erc20_heco_manager.go
...
/Users/moo/project/github/go-ethereum/build/bin/abigen --bin=./build/bin/TokenManager.bin --abi=./build/abi/TokenManager.abi --type=TokenManager --pkg=main --out=./deploy/heco/auto_gen_token_manager.go
